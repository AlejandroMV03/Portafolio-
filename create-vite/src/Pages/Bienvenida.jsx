      ...
      <div className="flex flex-col md:flex-row w-full max-w-4xl gap-8">
        ...
        <div className="flex flex-col flex-1 gap-6">
          ...
          <div className="bg-white/80 rounded-xl shadow-lg p-8 text-center">
            <h2 className="text-3xl font-bold mb-4 text-blue-900">¡Bienvenido a mi portafolio!</h2>
          ...
          {/* Card 2: Sobre mí */}
          <div className="bg-white/80 rounded-xl shadow-lg p-8 text-center">
            <h3 className="text-2xl font-semibold mb-3 text-blue-900">Sobre mí</h3>
            <p className="text-gray-700 text-lg leading-relaxed">
        ...
        <div className="flex flex-col flex-1 items-center justify-center">
          <div className="bg-white/80 rounded-xl shadow-lg p-8 flex flex-col items-center">
            <img
              ...
              className="w-36 h-36 rounded-full mb-4 border-4 border-blue-900 object-cover"
            />
            <p className="text-blue-900 font-semibold text-lg">Cristian Alejandro Mex Villacis</p>
          </div>
        </div>
      </div>
    </div>
